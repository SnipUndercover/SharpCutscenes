...
/// </summary>
public sealed class ModdedSaveFileStatistics : SaveFileStatistics
{
    #region Implementation Details
    internal ModdedSaveFileStatistics(SharpSaveData parent, SaveData saveData) : base(parent, saveData)
    {
    ...
    public sealed class ModdedChapterStatisticList
    {
        ...
        private readonly Dictionary<string, ChapterStatistics> Cache = [];
        ...
        /// </returns>
        public ChapterStatistics? this[string sid]
        {
            get
            {
                if (Cache.TryGetValue(sid, out ChapterStatistics? stats))
                    return stats;
