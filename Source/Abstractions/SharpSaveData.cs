...
public sealed class SharpSaveData
{
    ...
    /// </summary>
    public ChapterSideStatistics CurrentChapterSideStatistics
    {
        get
        {
            ...
            if (currentArea.ID <= (int)VanillaChapter.Farewell)
                return VanillaStatistics.Chapters[(VanillaChapter)currentArea.ID].Sides[(ChapterSide)currentArea.Mode];

            return ModdedStatistics.Chapters[currentArea.SID]!.Sides[(ChapterSide)currentArea.Mode];
        }
    }
    ...
    /// </summary>
    public readonly ModdedSaveFileStatistics ModdedStatistics;
    ...
    /// </summary>
    public readonly VanillaSaveFileStatistics VanillaStatistics;
    #endregion
}
